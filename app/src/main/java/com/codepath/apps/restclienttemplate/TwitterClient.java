...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CONSUMER_KEY = "QCwtRpFdrCMtKS1lzO2hE8hF1";
	public static final String REST_CONSUMER_SECRET = "Ns9LU4dMvSBbLg32l4mIVpRyzOQ4x52vVev1YZ3A4JubuSBaqW";
